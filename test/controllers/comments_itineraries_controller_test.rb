...
class CommentsItinerariesControllerTest < ActionController::TestCase
  ...
  test "should create comments_itinerary" do
    assert_difference('CommentsItinerary.count') do
      post :create, comments_itinerary: { comment: @comments_itinerary.comment, evalutiondate: @comments_itinerary.evalutiondate, itinerary_id: @comments_itinerary.itinerary_id, user_mobile_id: @comments_itinerary.user_mobile_id }
    end
  ...
  test "should update comments_itinerary" do
    patch :update, id: @comments_itinerary, comments_itinerary: { comment: @comments_itinerary.comment, evalutiondate: @comments_itinerary.evalutiondate, itinerary_id: @comments_itinerary.itinerary_id, user_mobile_id: @comments_itinerary.user_mobile_id }
    assert_redirected_to comments_itinerary_path(assigns(:comments_itinerary))
  end
