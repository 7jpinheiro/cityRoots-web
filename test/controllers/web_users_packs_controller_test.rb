...
class WebUsersPacksControllerTest < ActionController::TestCase
  ...
  test "should create web_users_pack" do
    assert_difference('WebUsersPack.count') do
      post :create, web_users_pack: { active: @web_users_pack.active, obs: @web_users_pack.obs, pack_type_id: @web_users_pack.pack_type_id, subscriptiondate: @web_users_pack.subscriptiondate, validity: @web_users_pack.validity, web_user_id: @web_users_pack.web_user_id }
    end
  ...
  test "should update web_users_pack" do
    patch :update, id: @web_users_pack, web_users_pack: { active: @web_users_pack.active, obs: @web_users_pack.obs, pack_type_id: @web_users_pack.pack_type_id, subscriptiondate: @web_users_pack.subscriptiondate, validity: @web_users_pack.validity, web_user_id: @web_users_pack.web_user_id }
    assert_redirected_to web_users_pack_path(assigns(:web_users_pack))
  end
