...
class MobileUsersControllerTest < ActionController::TestCase
  ...
  test "should create mobile_user" do
    assert_difference('MobileUser.count') do
      post :create, mobile_user: { active: @mobile_user.active, country_id: @mobile_user.country_id, username: @mobile_user.username }
    end
  ...
  test "should update mobile_user" do
    patch :update, id: @mobile_user, mobile_user: { active: @mobile_user.active, country_id: @mobile_user.country_id, username: @mobile_user.username }
    assert_redirected_to mobile_user_path(assigns(:mobile_user))
  end
