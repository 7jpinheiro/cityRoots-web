  ...
  def create
    ...
    respond_to do |format|
      if @rating_event.save
        format.html { redirect_to @rating_event, notice: 'Serviço de classificação para eventos criado com sucesso.' }
  ...
  def update
    respond_to do |format|
      if @rating_event.update(rating_event_params)
        format.html { redirect_to @rating_event, notice: 'Serviço de classificação para eventos actualizado com sucesso.' }
