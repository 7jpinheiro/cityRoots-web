  ...
  def create
    ...
    respond_to do |format|
      if @rating_attraction.save
        format.html { redirect_to @rating_attraction, notice: 'Rating attraction was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @rating_attraction.update(rating_attraction_params)
        format.html { redirect_to @rating_attraction, notice: 'Rating attraction was successfully updated.' }
